...
You can also learn how to expose Prometheus/Alertmanager/Grafana externally:
- [Expose via Gateway API](https://prometheus-operator.dev/kube-prometheus/kube/exposing-prometheus-alertmanager-grafana-gateway-api/) (recommended)
- [Expose via Ingress](https://prometheus-operator.dev/kube-prometheus/kube/exposing-prometheus-alertmanager-grafana-ingress/) (legacy, deprecated)
